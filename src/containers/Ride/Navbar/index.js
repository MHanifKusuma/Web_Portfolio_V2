...
import LogoImage from "@common/src/assets/image/ride/logo.svg";
        ...
        <Box {...row}>
          ...
          <Box {...menuWrapper}>
            <ScrollSpyMenu
              ...
              menuItems={Data.rideJson.MENU_LEFT_ITEMS}
              offset={-70}
            />
            <ScrollSpyMenu
              className="main_menu menuRight"
              menuItems={Data.rideJson.MENU_RIGHT_ITEMS}
              offset={-70}
            />
            ...
            >
              <ScrollSpyMenu
                ...
                menuItems={Data.rideJson.MENU_ITEMS}
                drawerClose={true}
                offset={-100}
              />
            </Drawer>
